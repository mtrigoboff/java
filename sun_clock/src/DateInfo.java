...
// (c) 1995 - 1997 MLT Software, Inc.  All Rights Reserved.
	...
	*/
	...
	private boolean computeNightTop (int month, int day)
	{
		...
		switch (month) {			// decide whether North or South shadow
			case 10: case 11: case 12: case  1: case  2:			// Oct - Feb
				nightTop = true;
				break;
			case  4: case  5: case  6: case  7: case  8:			// Apr - Aug
				nightTop = false;
				break;
			case 3:																						// Mar
	...
	private int timeZoneOffset (Date date)
	{
		...
		if (tzOffset == 0) {										// suspicious, could be result of error on Macs...
			...
			// cut the characters " GMT" off the end of this string, and parse it into a long.
