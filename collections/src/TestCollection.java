...
public class TestCollection {
    ...
    private static void enrollStudent(Student s, String campus, String program, Map<String, Map<String, Integer>> sheet) {
    ...
    private static void addStudentToClass(Student s, String className, Map<String, Set<Student>> classes) {
